...
namespace kafka_tests.Unit
{
    ...
    public class KafkaEndpointTests
    {
        ...
        public void EnsureEndpointCanBeResulved()
        {
            ...
            var endpoint = new DefaultKafkaConnectionFactory().Resolve(new Uri("http://localhost:8888"));
        ...
        {
            var endpoint1 = new DefaultKafkaConnectionFactory().Resolve(new Uri("http://localhost:8888"));
            var endpoint2 = new DefaultKafkaConnectionFactory().Resolve(new Uri("http://localhost:8888"));
        ...
        {
            var endpoint1 = new DefaultKafkaConnectionFactory().Resolve(new Uri("http://localhost:8888"));
            var endpoint2 = new DefaultKafkaConnectionFactory().Resolve(new Uri("http://localhost:1"));
